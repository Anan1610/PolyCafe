...
namespace GUI_PolyCafe
{
    public partial class frmTheLuuDong : Form
    {
        ...
        private void dgvDanhSachThe_CellClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            {
                dgvDanhSachThe.DataSource = null;
                dgvDanhSachThe.DataSource = bus.GetTheLuuDongList();
                return;
            }

            var ketQua = bus.TimKiemTheLuuDong(tuKhoa);

            if (ketQua.Count > 0)
            {
                dgvDanhSachThe.DataSource = null;
                dgvDanhSachThe.DataSource = ketQua;
            }
            else
            {
                MessageBox.Show("Không tìm thấy thẻ lưu động phù hợp.");
                dgvDanhSachThe.DataSource = null;
            }
        }
    }
